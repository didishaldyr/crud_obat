        ...
        <table class="table">
            ...
            <tbody> 
                ...
                <tr>
                    ...
                    <td>
                        <a href="update.php?id_obat=<?php echo $baris['id_obat']; ?>" class="btn btn-warning">Perbarui</a>
                        <a href="delete.php?id_obat=<?php echo $baris['id_obat']; ?>" class="btn btn-danger">Hapus</a>
                    </td>
                    <?php
                }
                ?>
